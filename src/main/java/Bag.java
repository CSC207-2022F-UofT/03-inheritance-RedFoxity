...
public abstract class Bag {
    ...
    public void setColor(String otherCl){
        this.color = otherCl;
    }
    ...
    public void increaseCapacity(int n) {
        this.capacity += n;
        String[] cnt = new String[this.capacity];
        System.arraycopy(this.contents,0,cnt,0,this.contents.length);
        this.contents = cnt;
